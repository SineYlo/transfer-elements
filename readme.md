...
If all of the above options are not suitable for any reason, you can [download the files](https://cdn.jsdelivr.net/npm/transfer-elements@1.0.2/dist/) and connect the library the way you need.
