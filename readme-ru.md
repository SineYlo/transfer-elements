...
Если все выше перечисленные варианты не подходят по какой-либо причине, можете [скачать файлы](https://www.jsdelivr.com/package/npm/transfer-elements) и подключить библиотеку так как вам нужно.
